...
deps = {
  ...
  'src/build':
    'https://github.com/ubiquiti/ubnt_libjingle_component_src_build.git@1aadbc537a6a39ea7476e918613288cf7f5b0e2b',
  'src/buildtools':
  ...
  'src/third_party/usrsctp/usrsctplib':
    'https://github.com/ubiquiti/ubnt-usrsctp.git@v0.2.0-alpha.1',
