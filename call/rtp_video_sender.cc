...
#if 0
  if (codec_specific_info->codecType == kVideoCodecH264 && codec_specific_info->codecSpecific.H264.last_fragment_in_frame)
    absl::get<RTPVideoHeaderH264>(rtp_video_header.video_type_header).has_last_fragement = true;
  else
#endif
